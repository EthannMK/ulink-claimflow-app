...
export const DEFAULT_INSURERS: InsurerConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      f('treatmentDate', 'Treatment Date', 'date', true, 'DD/MM/YY — date of first medical consultation'),
      f('hospital', 'Hospital / Provider', 'text', true, ''),
      f('diagnosis', 'Diagnosis', 'textarea', false, ''),
      f('amount', 'Claim Amount', 'amount', true, 'Total claim amount in MMK — the grand total at the bottom of the treatment table on page 2 (e.g. 2,521,100)'),
    ],
  },
